...
class CNNModel(nn.Module):
    ...
    """
    def __init__(self, embedding_dim: int, num_filters: int = 128, dropout: float = 0.5):
        super(CNNModel, self).__init__()
        
        # Multiple convolutional layers with different kernel sizes
        self.conv1 = nn.Conv1d(in_channels=1, out_channels=num_filters, kernel_size=3, padding=1)
        self.conv2 = nn.Conv1d(in_channels=1, out_channels=num_filters, kernel_size=5, padding=2)
        self.conv3 = nn.Conv1d(in_channels=1, out_channels=num_filters, kernel_size=7, padding=3)
...
class CNN:
    ...
    def _save_training_graph(self) -> None:
        ...
        fig.suptitle("CNN Training: Validation Performance per Epoch", fontsize=14, fontweight="bold")
        
        epochs = self.training_history["epoch"]
        
        # Training Loss plot
        axes[0, 0].plot(epochs, self.training_history["train_loss"], marker='o', linewidth=2, color='#E63946')
        ...
        # Precision plot
        axes[0, 1].plot(epochs, self.training_history["precision"], marker='o', linewidth=2, color='#2E86AB')
        ...
        # Recall plot
        axes[1, 0].plot(epochs, self.training_history["recall"], marker='s', linewidth=2, color='#A23B72')
        ...
        # F1 Score plot
        axes[1, 1].plot(epochs, self.training_history["f1"], marker='^', linewidth=2, color='#F18F01')
